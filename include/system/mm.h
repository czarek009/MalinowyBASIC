...
#define MINI_STACK_SIZE    0x400      /*  1KB  */
#define MINI_STACK_ADDRESS 0x400000   /*  4MB  */
#define STACK_SIZE         (MINI_STACK_ADDRESS - MINI_STACK_SIZE)
#define STACK_ADDRESS      (MINI_STACK_ADDRESS - MINI_STACK_SIZE)
