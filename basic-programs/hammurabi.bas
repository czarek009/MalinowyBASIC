...
446 GOSUB 720
447 GOTO 440
450 IF FNINT(D/2)<=S THEN 455
452 GOSUB 710
453 GOTO 440
455 IF D<10*P THEN 510
460 PRINT "BUT YOU HAVE ONLY";P;"PEOPLE TO TEND THE FIELDS!  NOW THEN,"
470 GOTO 440
510 LET S=S-FNINT(D/2)
511 GOSUB 800
515 LET Y=C
516 LET H=D*Y
517 LET E=0
521 GOSUB 800
522 IF FNINT(C/2)!=C/2 THEN 530
525 E=FNINT(S/C)
530 S=S-E+H
531 GOSUB 800
533 I=FNINT(C*(20*A+S)/P/100+1)
540 C=FNINT(Q/20)
542 Q=FNINT(10*(2*FNRND(1)-.3))
550 IF P<C THEN 210
552 LET D=P-C
...
965 PRINT "REALLY WASN'T TOO BAD AT ALL. ";FNINT(P*.8*FNRND(1));"PEOPLE"
...
"530 LET S=S-E+H",
"531 GOSUB 800",
"533 LET I=FNINT(C*(20*A+S)/P/100+1)",
"540 LET C=FNINT(Q/20)",
"542 LET Q=FNINT(10*(2*FNRND(1)-0.3))",
"550 IF P<C THEN 210",
"552 LET D=P-C",
"553 IF D>0.45*P THEN 560",
"554 LET P1=((Z-1)*P1+D*100/P)/Z",
...
"951 GOTO 990",
"960 PRINT \"YOUR PERFORMANCE COULD HAVE BEEN SOMEWHAT BETTER, BUT\"",
"965 PRINT \"REALLY WASN'T TOO BAD AT ALL. \";FNINT(P*0.8*FNRND(1));\" PEOPLE\"",
"970 PRINT \"WOULD DEARLY LIKE TO SEE YOU ASSASSINATED BUT WE ALL HAVE OUR\"",
"975 PRINT \"TRIVIAL PROBLEMS.\"",
"990 PRINT",
"991 FOR N=1 TO 10",
